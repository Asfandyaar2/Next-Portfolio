...
export const projects = [
  {
    id: 1,
    title: "3Solar System Planets to Explore",
...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "Led the design and development of scalable web applications by combining frontend (React.js, Next.js, Tailwind CSS) and backend (Node.js, NestJS, MongoDB, PostgreSQL) technologies. Provided complete SaaS and automation solutions tailored to business needs.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
